...
/* Component imports - Assuming these paths are correct relative to Roomlayout.vue */
import Navbar from '@/Components/Navbar.vue';
import Sidebar from '@/Components/Sidebar.vue';
import Sidebarsearch from '@/Components/RoomModals/Sidebarsearch.vue'; // Located inside Modals/
import EditRoomModal from '@/Components/RoomModals/EditRoomModal.vue'; // Located inside Modals/
import AddRoomModal from '@/Components/RoomModals/AddRoomModal.vue'; // Located inside Modals/
...
const searchSidebarVisible = ref(false); // Changed to false by default for better UX
...
const handleAddRoom = (newRoomData) => {
  // Generate a new ID by finding the current max ID and adding 1
...
const openEditModal = (room) => {
  // Clone room to avoid reactive mutation of the original list item before saving
