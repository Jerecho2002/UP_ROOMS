...
<template>
  <div class="bg-gray-200 font-sans min-h-screen">
    <MessageFunction
      ...
      :deleted-room-name="toastState.delete.name"
    />
    ...
    <!-- Modals -->
    <AppointmentModal
      :is-visible="modalState.appointment.visible"
      ...
      :initial-minute="modalState.appointment.data?.initialMinute"
      :editing-event="modalState.appointment.editing"
      @close="() => closeModal('appointment')"
      @success="handleAppointmentSuccess"
    />

    <OccupancyCheckModal
      :is-visible="modalState.occupancy.visible"
      :data="modalState.occupancy.data"
      @close="() => closeModal('occupancy')"
      @proceed="handleOccupancyProceed"
    />

    <EventViewerModal
      :is-visible="modalState.eventViewer.visible"
      :event="modalState.eventViewer.event"
      @close="() => closeModal('eventViewer')"
      @edit="handleEditEvent"
      @delete="handleDeleteEvent"
    />

    <DayEventsViewerModal
      :is-visible="modalState.dayViewer.visible"
      :events="modalState.dayViewer.events"
      :date="modalState.dayViewer.date"
      @close="() => closeModal('dayViewer')"
      @view-event="openEventViewer"
      @edit-event="handleEditEvent"
      @delete-event="handleDeleteEvent"
